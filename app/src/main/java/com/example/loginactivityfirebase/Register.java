                        ...
                        if(task.isSuccessful()){
                            ...
                            user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(Register.this,"Email verification mail has been sent",Toast.LENGTH_SHORT).show();
                                    }
                                    else{
                                      Toast.makeText(Register.this,"Email not sent check your email",Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
...
//                            }
                            Toast.makeText(Register.this,"User Registered and logged in",Toast.LENGTH_SHORT).show();
                            Toast.makeText(Register.this,"verify your email check mail",Toast.LENGTH_SHORT).show();
